...
[1mDESCRIPTION[0m
       [1mdocker  [22mis  a  client  for interacting with the daemon (see [1mdockerd(8)[22m)
       through the CLI.

       The Docker CLI has over 30 commands. The commands are listed below  and
       each has its own man page which explains usage and arguments.
...
[1mOPTIONS[0m
       ...
       [1m-H[22m, [1m--host[22m=[[4munix:///var/run/docker.sock[24m]: tcp://[host]:[port][path]  to
       bind or unix://[/path/to/socket] to use.
         The socket(s) to bind to in daemon mode specified using one or more
         tcp://host:port/path,  unix:///path/to/socket,  fd://*  or fd://sock‐
       etfd.
         If the tcp port is not specified, then it will default to either [1m2375[0m
       when
